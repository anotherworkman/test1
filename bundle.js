...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DirectoryPageDirectoryPage = __webpack_require__(177);

	var _DirectoryPageDirectoryPage2 = _interopRequireDefault(_DirectoryPageDirectoryPage);

	var _dataGetDirectoriesJson = __webpack_require__(174);

	var _dataGetDirectoriesJson2 = _interopRequireDefault(_dataGetDirectoriesJson);

	var _dataGetDirectoryJson = __webpack_require__(169);

	var _dataGetDirectoryJson2 = _interopRequireDefault(_dataGetDirectoryJson);

	__webpack_require__(166);

	_react2['default'].render(
	//<DirectoriesPage directories={directories.response.directories}/>,
	_react2['default'].createElement(_DirectoryPageDirectoryPage2['default'], { directory: _dataGetDirectoryJson2['default'].response.directory }), document.body.firstChild);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bemBlock = 'directory-page';

	var DirectoryPage = (function (_React$Component) {
	    _inherits(DirectoryPage, _React$Component);

	    function DirectoryPage() {
	        _classCallCheck(this, DirectoryPage);

	        _get(Object.getPrototypeOf(DirectoryPage.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(DirectoryPage, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: (0, _BemHelper.className)(bemBlock, 'nav-box') },
	                    _react2['default'].createElement(_NavNav2['default'], { path: ['Справочники'], title: this.props.directory.name })
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'button' },
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: (0, _BemHelper.className)(bemBlock, 'content') },
	                    _react2['default'].createElement(
	                        'div',
	                        { className: (0, _BemHelper.className)(bemBlock, 'entries-table-box') },
	                        _react2['default'].createElement(_EntriesTableEntriesTable2['default'], { directory: this.props.directory })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".nav__path {\n  font-size: 14px;\n}\n.nav__path-item:after {\n  content: '\\2192';\n  font-family: Arial, sans-serif;\n  font-size: 13px;\n  padding-left: 4px;\n}\n.nav__header {\n  font-size: 30px;\n  color: #0B0B0B;\n  padding-top: 11px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./DirectoryPage.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./DirectoryPage.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".directory-page__nav-box {\n  margin-bottom: 22px;\n}\n.directory-page__content {\n  white-space: nowrap;\n}\n.directory-page__entries-table-box {\n  display: inline-block;\n  white-space: normal;\n}\n.directory-page__entries-filter-box {\n  display: inline-block;\n  white-space: normal;\n  vertical-align: top;\n  padding-left: 25px;\n  padding-top: 15px;\n}\n.entries-filter__title {\n  font-size: 14px;\n  padding-left: 15px;\n  margin-bottom: 10px;\n}\n.entries-filter__input-form {\n  border: solid 1px #CECECE;\n  border-radius: 10px;\n  padding: 15px 15px 48px;\n}\n.entries-filter__input-box {\n  border: solid 1px #CECECE;\n  border-radius: 2px;\n  padding: 6px 5px;\n  width: 168px;\n  background: #FEFEFE;\n  color: #BFBFBF;\n  font-size: 11px;\n  font-family: Arial, sans-serif;\n}\n", ""]);
